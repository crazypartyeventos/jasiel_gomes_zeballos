...
function PhotoCard(t0) {
    ...
    if ($[0] !== "008cfc71a5a02f614c5f3f584fa1d5041660c9ced81730c3b02aa94f4bb97a7b") {
        for(let $i = 0; $i < 13; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "008cfc71a5a02f614c5f3f584fa1d5041660c9ced81730c3b02aa94f4bb97a7b";
    }
    const { image, borderColor } = t0;
    ...
    const t3 = `border-8 rounded-3xl overflow-hidden shadow-lg transition-transform duration-700 transform ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`;
    let t4;
    if ($[4] !== borderColor) {
        t4 = {
            borderColor
...
//# sourceMappingURL=_e32fc45e._.js.map